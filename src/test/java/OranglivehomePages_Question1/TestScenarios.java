package OranglivehomePages_Question1;
...
// - Scenario1: Login into OrangeHRM application
	/*	Scenario 1-
...
// - Scenario2: Search Directory for a user and assert the user from search results
 /* Scenario 2-
 ...
 //- Scenario3: Search for Admin user and click add button for searched employee/user
 /* 
